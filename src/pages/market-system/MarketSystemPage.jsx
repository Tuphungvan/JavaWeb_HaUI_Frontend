...
const MarketSystemPage = () => {
  ...
  const updateDistricts = () => {
    if (selectedProvince) {
      ...
      if (provinceData) {
        const districtOptions = Object.entries(provinceData.districts).map(
          ([key, district]) => ({
            value: key,
            name: district.name,
          })
        ...
        <div className="container w-[84%]">
          <div>
            <div className="flex items-center gap-3 mb-10">
              ...
              <p className="font-bold text-amber-600">Hệ thống cửa hàng</p>
            </div>
            {/*  */}
              ...
              <div className="flex flex-col justify-around items-start gap-5 lg:item-start lg:flex-row ">
                <div className="flex gap-3 items-center">
                  <div className=" rounded-full p-4 bg-[#ff6347]">
                    <IoStorefront size={30} color="#ffffff" />
                  </div>
                ...
                <div className="flex gap-3 items-center">
                  <div className=" rounded-full p-4 bg-[#ff6347]">
                    <HiMiniUserGroup size={30} color="#ffffff" />
                  </div>
                  <div className="flex flex-col font-normal">
